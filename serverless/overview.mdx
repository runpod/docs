...
The typical Serverless development workflow follows this pattern: 

1. [Write a handler function](/serverless/workers/handler-functions).
2. [Test it locally](/serverless/development/local-testing).
3. [Create a Dockerfile](/serverless/workers/create-dockerfile) to package the handler function.
...
6. [Monitor logs](/serverless/development/logs), [debug running workers](/serverless/development/ssh-into-workers), and [optimize your endpoints](/serverless/development/optimization).
...
If you don't want to start from scratch and [build your own custom worker](/serverless/workers/custom-worker), Runpod offers several ways to rapidly deploy and test pre-configured AI models, without writing your own handler function:
...
Runpod maintains a collection of [Public Endpoints](/hub/public-endpoints) on the Runpod Hub that you can use to integrate pre-configured AI models into your applications quickly, without writing your own handler function or deploying your own workers.
