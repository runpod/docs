...
flowchart TD
    ...
    Queue --> CheckActive{Workers<br/>available?}
    ...
    style CheckActive fill:#1B0656,stroke:#874BFF,color:#FFFFFF,stroke-width:3px
    style Start fill:#5D29F0,stroke:#874BFF,color:#FFFFFF,stroke-width:3px
    style End fill:#5D29F0,stroke:#874BFF,color:#FFFFFF,stroke-width:3px
    style ColdStart fill:#FCB1FF,stroke:#AE6DFF,color:#000000,stroke-width:3px
    style Queue fill:#874BFF,stroke:#AE6DFF,color:#FFFFFF,stroke-width:3px
    style WaitWorker fill:#FFC01F,stroke:#FF6214,color:#000000,stroke-width:3px
    style Process fill:#5D29F0,stroke:#874BFF,color:#FFFFFF,stroke-width:3px
