...
To get started with Serverless, follow one of the following guides to build your first worker and deploy it as an endpoint.
...
<CardGroup>
    ...
    <Card title="Deploy a vLLM worker" href="/serverless/vllm/get-started" icon="cloud-bolt" iconType="solid">
        Deploy a large language model for text or image generation using vLLM.
    </Card>
</CardGroup>
