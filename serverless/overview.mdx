...
Runpod provides comprehensive [logging capabilities](/serverless/logs) to help you monitor and debug your Serverless applications:

* **90-day log retention**: All serverless logs are automatically stored for at least 90 days
* **Real-time streaming**: View logs in near real-time through the RunPod console
* **Persistent storage**: Write logs to network volumes for permanent retention
* **Centralized access**: Access all logs through the Logs tab in your endpoint dashboard
