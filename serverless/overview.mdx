...
* GPU-powered computing: Access powerful GPUs for <InferenceTooltip />, <TrainingTooltip />, and other compute-intensive tasks.
...
<CardGroup>
    ...
    <Card title="Deploy a pre-configured endpoint" href="/tutorials/serverless/run-your-first" icon="image" horizontal>
...
<CardGroup cols={2}>
  <Card title="Build your first worker" href="/serverless/workers/custom-worker" icon="bolt" horizontal>
    Create and deploy a custom Serverless worker.
  </Card>
  <Card title="Endpoints" href="/serverless/endpoints/overview" icon="link" horizontal>
    Learn how to configure and manage endpoints.
  </Card>
  <Card title="Workers" href="/serverless/workers/overview" icon="server" horizontal>
  ...
  <Card title="Deploy LLMs with vLLM" href="/serverless/vllm/overview" icon="message-bot" horizontal>
    Deploy large language models in minutes.
  </Card>
  <Card title="Storage options" href="/serverless/storage/overview" icon="hard-drive" horizontal>
