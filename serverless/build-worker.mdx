---
title: "Build a custom worker"
sidebarTitle: "Build a custom worker"
description: "Write a handler function, build a worker image, and deploy your own Serverless endpoint."
---
...
<Tip>
For an even faster start, clone or download the [worker-basic](https://github.com/runpod-workers/worker-basic) repository for a pre-configured template. After cloning, skip to [Step 6](#step-6-build-and-push-your-docker-image) to deploy and test.
</Tip>
