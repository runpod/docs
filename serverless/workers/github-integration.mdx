...
When you make changes to your GitHub repository, they won't automatically be pushed to your Serverless workers. To trigger a rollout for the workers on your endpoint, create a new release for the GitHub repository.
