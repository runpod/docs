...
To debug issues in production, you can [SSH directly into running workers](/serverless/workers/ssh-into-workers) to inspect logs, file systems, and environment variables in real-time.
