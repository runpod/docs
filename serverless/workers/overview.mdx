...
By default, a single Runpod account can have a maximum of 5 workers (flex + active combined) allocated across all endpoints. You can automatically increase this number if you have a sufficiently high account balance, starting at \$100 for 10 workers up to \$900 for 60 workers.
