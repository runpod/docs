...
To debug issues with your workers, you can [SSH directly into running workers](/serverless/workers/ssh-into-workers) for real-time debugging and troubleshooting.
