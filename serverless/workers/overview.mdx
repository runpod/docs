...
To package your worker, you need to [create a Dockerfile](/serverless/workers/create-dockerfile) that packages your handler function and all its dependencies. 

Once you've created your Dockerfile, you can deploy your worker to a Serverless endpoint using one of the following methods:
...
Runpod Serverless offers several storage options for your workers:
