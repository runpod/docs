...
Because fitness checks don't run during local testing, you can invoke the runner manually to confirm your checks behave as expected before deploying:
...
async def test_fitness_checks():
    """Run registered fitness checks manually."""
    try:
