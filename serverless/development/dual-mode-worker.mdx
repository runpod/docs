...
<Tree>
  <Tree.Folder name="dual-mode-worker" defaultOpen>
    <Tree.File name="handler.py" comment="Your Python script with the Runpod handler logic" />
    <Tree.File name="start.sh" comment="A shell script that will be the entrypoint for your Docker container" />
    <Tree.File name="Dockerfile" comment="Instructions to build your Docker image" />
    <Tree.File name="requirements.txt" comment="A file to list Python dependencies" />
  </Tree.Folder>
</Tree>
