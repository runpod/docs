...
You can also read worker logs from the terminal with [`runpodctl serverless logs`](/runpodctl/reference/runpodctl-serverless), which streams them as JSON Lines tagged by worker ID.
