...
Runpod Serverless works with any system that supports custom endpoint configuration. If a library or framework lets you set a custom base URL, you can connect it to your Runpod endpoints without specialized adapters or connectors.
