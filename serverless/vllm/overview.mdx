...
For a hands-on example, see [Create a chatbot with Gemma 3](/tutorials/serverless/run-gemma-7b) to deploy a vLLM endpoint and build an interactive chatbot using the OpenAI-compatible API.
