...
FlashBoot is enabled by default for GPU endpoints. For CPU endpoints, FlashBoot is available in Beta.
New CPU endpoints will have FlashBoot enabled by default, and you can edit existing endpoints to enable or disable FlashBoot.
