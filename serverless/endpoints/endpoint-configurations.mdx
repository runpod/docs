...
You can select a pre-cached model from Hugging Face or from your [Private model repository](/serverless/storage/model-repo) to optimize worker initialization times and reduce costs.
