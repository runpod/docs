...
The TTL controls how long a job's data is retained in the system, covering **both queue time and execution time**. The default is 24 hours, and it can be extended up to 7 days.
