...
<Note>
Pre-cached models are currently in beta. [Join our Discord](https://discord.gg/runpod) if you'd like to provide feedback.
</Note>
...
- **Faster cold start times:** Many public models have been pre-cached on Runpod's infrastructure, eliminating the need for workers to download them from external sources like Hugging Face.
