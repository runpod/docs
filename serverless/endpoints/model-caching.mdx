...
- **Shared across workers:** Multiple workers running on the same host <MachineTooltip /> can reference the same cached model, eliminating redundant downloads and saving disk space.
