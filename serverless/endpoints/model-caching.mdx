...
## Using cached models in your worker
...
To dynamically locate cached models without hardcoding paths, you can use this helper function to scan the cache directory:
