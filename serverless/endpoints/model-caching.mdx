...
You can also set cached models from the command line using [`runpodctl serverless update`](/runpodctl/reference/runpodctl-serverless) with the `--model-reference` flag.
