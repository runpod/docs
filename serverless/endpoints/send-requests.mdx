...
| ------------------ | ------------------------------------------- | ------------------- | ------------------------------ |
| `executionTimeout` | Maximum time a job can run while being processed by a worker | 600000 (10 minutes) | Min 5000 ms, max 7 days  |
| `lowPriority`      | When true, job won't trigger worker scaling | false               | -                              |
| `ttl`              | How long job data is retained while queued or in progress | 86400000 (24 hours) | Min 10000 ms, max 7 days |
