...
After creating a [Severless endpoint](/serverless/endpoints/overview), you can start sending it requests to submit <JobsTooltip /> and retrieve results. This page covers everything from basic input structure and job submission, to monitoring, troubleshooting, and advanced options for queue-based endpoints.
