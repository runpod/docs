...
3. On the **Deploy a New Serverless Endpoint** screen, choose your deployment source:
   * **Import Git Repository**: See [Deploy from GitHub] for details(/serverless/workers/github-integration).
...
For a full description of all endpoint settings, see [Endpoint configurations](/serverless/endpoints/endpoint-configurations).
