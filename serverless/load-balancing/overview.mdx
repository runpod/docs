...
| `RUNPOD_ALLOW_IP` | Unset (allow all) | Comma-separated IP addresses or CIDR ranges allowed to send requests to the endpoint. See [IP allowlist](/serverless/endpoints/endpoint-configurations#ip-allowlist) |
