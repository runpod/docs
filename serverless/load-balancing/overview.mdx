...
When you deploy your endpoint, make sure to add any custom ports to your endpoint's environment variables, and expose them in the container configuration of your endpoint settings (under **Expose HTTP Ports**).
