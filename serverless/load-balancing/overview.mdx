...
If you don't set `PORT` or `PORT_HEALTH` during deployment, environment variables will automatically be set to `8888` for both, and port 8888 will be automatically exposed in the container configuration.
