...
After sending a request, your workers will take some time to initialize. You can check the logs in the **Workers** tab of your endpoint page to track their progress.
