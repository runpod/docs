...
All requests to load balancing endpoints require an Authorization header with your [API key](/get-started/api-keys). `POST` requests require an API key with **Read/Write** or **All** permissions.
