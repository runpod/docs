...
You can download a preconfigured repository that includes all the files created in this tutorial [on GitHub](https://github.com/muhsinking/load-balancing-worker).
