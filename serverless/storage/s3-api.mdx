...
|------------------|--------|-----------------|-------|
| `CopyObject` | ✅ | `aws s3 cp`, `aws s3 sync`, `aws s3api copy-object` | Copy objects between locations |
...
| Operation | Supported | CLI Command | Notes |
|------------------|--------|-----------------|-------|
| `CreateBucket` | ❌ | `aws s3api create-bucket` | Use Runpod console to create network volumes |
| `DeleteBucket` | ❌ | `aws s3api delete-bucket` | Use Runpod console to delete network volumes |
| `GetBucketLocation` | ❌ | `aws s3api get-bucket-location` | Datacenter info available in console |
| `GetBucketVersioning` | ❌ | `aws s3api get-bucket-versioning` | Versioning not supported |
| `PutBucketVersioning` | ❌ | `aws s3api put-bucket-versioning` | Versioning not supported |
