...
|------------------|--------|-----------------|-------|
| `CopyObject` | ✅ | `aws s3 cp`, `aws s3 sync` | Copy objects between locations |
| `DeleteObject` | ✅ | `aws s3 rm` | Remove individual objects |
| `GetObject` | ✅ | `aws s3 cp`, `aws s3api get-object` | Download objects |
| `HeadBucket` | ✅ | `aws s3 ls` | Verify bucket exists and permissions |
| `HeadObject` | ✅ | `aws s3api head-object` | Retrieve object metadata |
| `ListBuckets` | ✅ | `aws s3 ls` | List available network volumes |
| `ListObjects` | ✅ | `aws s3 ls` | List objects in a bucket (includes empty directories) |
| `ListObjectsV2` | ✅ | `aws s3 ls` | Enhanced version of ListObjects |
...
| Operation | Supported | CLI Command | Notes |
|------------------|--------|-----------------|-------|
| `CreateMultipartUpload` | ✅ | `aws s3 cp` (automatic) | Start multipart upload for large files |
| `UploadPart` | ✅ | `aws s3 cp` (automatic) | Upload individual parts |
| `CompleteMultipartUpload` | ✅ | `aws s3 cp` (automatic) | Finish multipart upload |
...
| Operation | Supported | CLI Command | Notes |
|------------------|--------|-----------------|-------|
| `DeleteObjects` | ❌ | `aws s3 rm --recursive` | Batch delete multiple objects |
| `RestoreObject` | ❌ | N/A | Restore archived objects |

### Bucket management operations

| Operation | Supported | CLI Command | Notes |
|------------------|--------|-----------------|-------|
| `CreateBucket` | ❌ | N/A | Use Runpod console to create network volumes |
| `DeleteBucket` | ❌ | N/A | Use Runpod console to delete network volumes |
| `GetBucketLocation` | ❌ | N/A | Datacenter info available in console |
| `GetBucketVersioning` | ❌ | N/A | Versioning not supported |
| `PutBucketVersioning` | ❌ | N/A | Versioning not supported |

### Access control and permissions

| Operation | Supported | CLI Command | Notes |
|------------------|--------|-----------------|-------|
| `GetBucketAcl` | ❌ | N/A | ACLs not supported |
| `PutBucketAcl` | ❌ | N/A | ACLs not supported |
| `GetObjectAcl` | ❌ | N/A | ACLs not supported |
| `PutObjectAcl` | ❌ | N/A | ACLs not supported |
| `GetBucketPolicy` | ❌ | N/A | Bucket policies not supported |
| `PutBucketPolicy` | ❌ | N/A | Bucket policies not supported |

### Object metadata and tagging

| Operation | Supported | CLI Command | Notes |
|------------------|--------|-----------------|-------|
| `GetObjectTagging` | ❌ | N/A | Object tagging not supported |
| `PutObjectTagging` | ❌ | N/A | Object tagging not supported |
| `DeleteObjectTagging` | ❌ | N/A | Object tagging not supported |

### Encryption and security

| Operation | Supported | CLI Command | Notes |
|------------------|--------|-----------------|-------|
| `GetBucketEncryption` | ❌ | N/A | Encryption not supported |
| `PutBucketEncryption` | ❌ | N/A | Encryption not supported |
| `GetObjectLockConfiguration` | ❌ | N/A | Object locking not supported |
| `PutObjectLockConfiguration` | ❌ | N/A | Object locking not supported |
