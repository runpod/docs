...
The RunPod S3 API supports the following operations. For detailed information on each, refer to the [AWS s3API documentation](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/s3api/index.html).
...
- [AWS CLI s3API reference](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/s3api/index.html).
