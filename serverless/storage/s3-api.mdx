...
Using the S3-compatible API to access your network volumes does not affect pricing. Network volumes are billed at \$0.07 per GB per month for the first 1TB, and \$0.05 per GB per month for additional storage beyond that.
