...
When running `aws s3 ls` or `ListObjects` on a large directory (typically >10,000 files or >10 GB of data) for the first time, it may run very slowly, or you may encounter the following error: 
