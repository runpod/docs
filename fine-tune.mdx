...
Below is a configuration example using common settings. You can replace `NousResearch/Meta-Llama-3-8B` and `tatsu-lab/alpaca` with whichever base model and dataset you selected:
...
sequence_len: 4096        # Increase if using an A100 80GB GPU
sample_packing: true
pad_to_sequence_len: true

# 5. Training optimization
gradient_accumulation_steps: 4
micro_batch_size: 2       # Adjusted for better GPU utilization
num_epochs: 1
optimizer: paged_adamw_8bit
lr_scheduler: cosine
learning_rate: 2e-4       # QLoRA typically needs a slightly higher learning rate

# 6. Hardware acceleration
train_on_inputs: false
group_by_length: false
bf16: true                # Llama 3.1 is native BF16
fp16: false
tf32: true                # Enable for Ampere/Hopper GPUs
