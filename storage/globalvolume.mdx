...
description: "Attach elastic, region-independent storage to GPU Pods across all data centers, with data that persists across sessions."
tag: "Beta"
---
...
You can also [attach global volumes to Serverless endpoints](/storage/globalvolume-serverless).
