...
- **Eventual consistency:** Reads reflect the state of the volume at mount time. Updates made to the volume after the Pod starts may not be immediately visible inside the container.
