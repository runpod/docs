...
The volume appears in your Storage list with a **Global** badge. Storage grows automatically as you add data. There is no capacity to provision upfront.

## Attach a global volume to a Pod

You can attach a global volume when deploying a new Pod.

**From the volume detail page:** Go to **Storage**, click your global volume, then click **Configure Pod with volume**. This opens the Pod deployment page with the volume pre-selected.
