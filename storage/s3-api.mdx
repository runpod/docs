...
<Tip>
[Watch this video](https://www.youtube.com/watch?v=XA01UEE4TYc) for a quickstart example that demonstrates how to automatically sync a network volume with a local directory. You can find the syncing script on GitHub: [/runpod/examples/s3-api-downloader](https://github.com/runpod/examples/tree/main/s3-api-downloader).
</Tip>
