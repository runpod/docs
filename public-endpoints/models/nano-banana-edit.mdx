...
Google is discontinuing the underlying model. Migrate to [Nano Banana 2 Edit](/public-endpoints/models/nano-banana-2-edit) before that date — it handles the same multi-image editing and adds resolution options up to 4K.
</Warning>
