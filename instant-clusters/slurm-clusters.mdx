...
4. Configure your cluster specifications:
   ...
   - **Pod template**: Select a [Pod template](/pods/templates/overview) or click **Edit Template** to customize start commands, environment variables, ports, or [container/volume disk](/pods/storage/types) capacity. **Only official Runpod Pytorch images are currently supported.**
