...
sidebarTitle: "Deploy with Slurm (unmanaged)"
---

<Tip>

This guide is for advanced users who want to manage their own Slurm cluster. If you're looking for a managed solution, see [Deploy an Instant Cluster with Slurm (managed)](/instant-clusters/slurm-managed).
