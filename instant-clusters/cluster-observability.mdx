...
1. Launch an Instant Cluster from the [Runpod console](https://console.runpod.io).
2. Once the cluster is running, click the **Grafana** button on the cluster detail page.
3. The dashboard opens automatically — no login or setup required.
