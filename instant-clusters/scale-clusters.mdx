...
Each pod you add contributes the same GPU configuration as your existing cluster nodes. For example, a cluster with 2 pods running 8× H100 SXMs each (16× H100 SXMs / 1280 GB total) becomes a 3-pod cluster with 24× H100 SXMs (1280+1920 GB) after adding one pod.
