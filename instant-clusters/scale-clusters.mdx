...
<Note>
  Cluster scaling is currently in alpha and is available to eligible accounts. If you don't see the **Scale cluster** button, [contact sales](https://www.runpod.io/contact) to request access.
</Note>
