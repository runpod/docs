...
Each pod you add contributes the same GPU configuration as your existing cluster nodes. For example, a cluster with 2 pods running 2× H100 SXMs each (4× H100 SXMs / 320 GB total) becomes a 3-pod cluster with 6× H100 SXMs (480 GB) after adding one pod.
