...
**Python 3.11 or 3.12 is required.** Python 3.13 and later versions are not supported. Using an unsupported Python version will cause deployment failures. Flash is currently available for macOS and Linux.
</Warning>
