...
<CardGroup>
  ...
  <Card title="Build an app" href="/flash/build-app" icon="code">
...
[Follow this tutorial](/flash/build-app) to build your first Flash app.
...
[Learn more about the Flash app workflow](/flash/build-apps-overview).
