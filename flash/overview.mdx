...
Flash supports two primary workflows for running workloads on Runpod: scripts and apps.

### Flash scripts

This is the fastest way to get started with Flash. Just write a Python script with a resource configuration and a `@remote` decorated function, and run it locally with `python script.py`.
