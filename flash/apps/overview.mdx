...
3. Provisions independent Serverless endpoints based on your [endpoint configurations](/flash/endpoint-functions).
...
<Steps>
  ...
  <Step title="Develop">
    ...
    [Learn more about endpoint functions](/flash/endpoint-functions).
  </Step>
