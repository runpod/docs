...
Load-balanced endpoints:
  https://api-abc123.runpod.net  (lb_worker)
    POST   /process
    GET    /health

Queue-based endpoints:
  https://api-def456.runpod.net  (gpu_worker)
  https://api-ghi789.runpod.net  (cpu_worker)
```
...
curl -X POST https://api-abc123.runpod.net/process \
