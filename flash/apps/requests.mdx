...
<CardGroup cols={2}>
  ...
  <Card title="Queue-based configs" href="/flash/configuration/queue-based" icon="layer-group" horizontal>
    Configure queue-based endpoints.
  </Card>
  <Card title="Load balancing configs" href="/flash/configuration/load-balancing" icon="arrow-progress" horizontal>
