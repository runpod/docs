...
[REMOTE] LiveServerless:rb50waqznmn2kg | API /run
LiveServerless:rb50waqznmn2kg | Started Job:b0b341e7-...
Job:b0b341e7-... | Status: IN_QUEUE
Job:b0b341e7-... | Request assigned to worker icmkdgnrmdf8gz, streaming pod logs ...
Job:b0b341e7-... | Status: COMPLETED
```

The `[REMOTE]` tag indicates the point where your function code is dispatched to run on Runpod's cloud infrastructure. This helps you understand which parts of your application execute locally versus remotely.

For load-balanced endpoints, you'll see similar tags:
