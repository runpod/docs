...
<CardGroup cols={2}>
  <Card title="Generate images with Flash" href="/tutorials/flash/image-generation-with-sdxl" icon="image">
    Use Stable Diffusion XL to generate images from text prompts.
  </Card>
  <Card title="Generate text with Flash" href="/tutorials/flash/text-generation-with-transformers" icon="message-bot">
