...
See [GPU types](/flash/configuration/gpu-types) for available GPUs or [endpoint functions](/flash/endpoint-functions) for all configuration options.
...
<CardGroup cols={2}>
  ...
  <Card title="Endpoint functions" href="/flash/endpoint-functions" icon="function" horizontal>
