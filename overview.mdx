...
<CardGroup>
    <Card title="Quickstart" href="/get-started" icon="bolt-lightning">
        Create an account, deploy your first GPU Pod, and use it to execute code.
    </Card>
    <Card title="Manage accounts" href="/get-started/manage-accounts" icon="users">
        Learn how to manage your individual or team accounts.
    </Card>
    <Card title="Create an API key" href="/get-started/api-keys" icon="key">
        Create API keys to manage your access to RunPod resources.
    </Card>
    <Card title="Connection options" href="/get-started/connect-to-runpod" icon="plug">
...
<CardGroup>
    ...
    <Card title="Build your first worker" href="/serverless/workers/custom-worker" icon="code">
        Build and deploy your first custom Serverless worker.
    </Card>
</CardGroup>
...
<Columns cols={3}>
    ...
    <Card title="Contact" href="https://contact.runpod.io/hc/requests/new" icon="headset">
        Submit a support request using our contact page.
    </Card>
    <Card title="Status page" href="https://status.runpod.io" icon="chart-line">
