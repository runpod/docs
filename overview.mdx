...
<CardGroup cols={3}>
    ...
    <Card title="Flash" href="/flash/overview" icon="bolt" horizontal>
...
Runpod offers [Public Endpoints](/public-endpoints/overview) for instant API access to pre-deployed AI models for image, video, audio, and text generation. No deployment or infrastructure required—just [create an API key](/get-started/credentials#api-keys) and make a request:
