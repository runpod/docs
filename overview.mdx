...
<CardGroup>
    ...
    <Card title="Choose a Pod" href="/pods/choose-a-pod" icon="cart-shopping" iconType="solid">
...
<CardGroup>
    <Card title="Instant Clusters" href="/instant-clusters" icon="boxes-stacked" iconType="solid">
