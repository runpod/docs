...
<CardGroup>
    ...
    <Card title="Manage accounts" href="/get-started/manage-accounts" icon="users" iconType="duotone">
    ...
    <Card title="Connection options" href="/get-started/connect-to-runpod" icon="plug" iconType="duotone">
...
<CardGroup>
    ...
    <Card title="vLLM quickstart" href="/serverless/vllm/get-started" icon="cloud-bolt" iconType="duotone">
        Deploy a large language model for text or image generation in minutes using a vLLM.
    </Card>
    <Card title="Build your first worker" href="/serverless/workers/custom-worker" icon="code" iconType="duotone">
...
<CardGroup>
    <Card title="Introduction" href="/pods/overview" icon="microchip" iconType="duotone">
        Understand the components of a Pod and options for congiruation.
    </Card>
    <Card title="Choose a Pod" href="/pods/choose-a-pod" icon="server" iconType="duotone">
...
<Columns cols={3}>
    <Card title="Contact" href="https://contact.runpod.io" icon="headset" iconType="duotone">
        Submit a support request using our contact page.
    </Card>
    <Card title="Status page" href="https://uptime.runpod.io/" icon="chart-line" iconType="duotone">
