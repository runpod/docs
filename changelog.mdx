...
<Update label="September 2025" description="Slurm Instant Clusters, Model Store in beta, and new public endpoints">
...
<Update label="August 2025" description="Hub revenue share for maintainers and new Pods UX">
...
<Update label="July 2025" description="Public models via API and one-click Slurm clusters">
...
<Update label="June 2025" description="Upload and retrieve files without compute and updated referral program">
...
<Update label="May 2025" description="UX polish, further price relief, and a marketplace with new Python library">
...
<Update label="April 2025" description="SSO convenience and wider global mesh">
...
<Update label="March 2025" description="Enterprise features: compliance, APIs, clusters, bare metal, and APAC expansion">
...
<Update label="February 2025" description="Modern API surface in beta and stronger community investment">
...
<Update label="January 2025" description="New silicon options and LLM-centric Serverless upgrades">
...
<Update label="November 2024" description="Global networking rollout continues and GitHub deploys arrive in beta">
...
<Update label="August 2024" description="More storage coverage and private cross-DC connectivity">
...
<Update label="July 2024" description="Storage coverage grows, major price cuts, and revamped referrals">
...
<Update label="May 2024" description="$20M seed round, community event, and broader Serverless and accelerator options">
...
<Update label="February 2024" description="Compute beyond GPUs and first-class automation tooling">
...
<Update label="January 2024" description="Console navigation overhaul and documentation refresh">
...
<Update label="December 2023" description="New regions and investment in community and support">
...
<Update label="October 2023" description="Faster starts from templates and better multi-region hygiene">
...
<Update label="September 2023" description="Self-service upgrades, clearer metrics, new pricing model, and cost visibility">
...
<Update label="August 2023" description="Team governance, storage expansion, and better debugging and health">
...
<Update label="June 2023" description="Observability, top-tier GPUs, and commitment-based savings">
...
<Update label="May 2023" description="Smoother auth and multi-region Serverless with persistent storage">
...
<Update label="April 2023" description="Deeper autoscaling controls, richer metrics, persistent storage, and job cancellation">
...
<Update label="April 1, 2023" description="Serverless platform hardens with a cleaner, more capable API">
...
<Update label="February 1, 2023" description="Better control over notifications and GPU allocation during contention">
...
<Update label="July 1, 2022" description="Security-first release enabling encryption for persistent data">
