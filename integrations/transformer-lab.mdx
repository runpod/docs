...
Here's an example task configuration for fine-tuning a model on Runpod. Create a new task in the Tasks menu and use this YAML:
...
Select your Runpod compute provider and click **Queue** to start the training job.
