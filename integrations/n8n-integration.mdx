...
<Tip>
For a faster start, you can point your n8n workflow to a [Public Endpoint](/hub/public-endpoints) instead of deploying a vLLM worker. To do this, skip to [step 2](#step-2-create-an-n8n-workflow) to create your workflow, then in step 3 set the base URL to the Public Endpoint URL for Qwen3 32B AWQ:
