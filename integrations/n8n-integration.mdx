...
<Tip>
For a faster start, you can use a [Public Endpoint](/hub/public-endpoints) instead of deploying a vLLM worker. To try this, skip to [step 2](#step-2-create-an-n8n-workflow), and set the base URL in step 3 to the Public Endpoint URL for Qwen3 32B AWQ:
