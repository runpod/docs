...
Use this method to run the server locally with an API key stored in your client config. For example, choose this method if your client doesn't support the hosted server's sign-in flow, or if you prefer to manage the credential yourself.
