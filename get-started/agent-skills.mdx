...
That's it. Restart your agent, then ask it to manage Runpod in plain English:

- "List my Runpod endpoints"
- "Spin up an A100 Pod"
- "Deploy this handler to Serverless"

The router picks the right skill and drives the tools for you. If something isn't set up yet, the plugin detects it and walks you through the missing step.
