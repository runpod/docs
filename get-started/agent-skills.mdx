...
description: "Give your AI coding agent the ability to manage GPU workloads on Runpod."
tag: "NEW"
---

Agent skills teach AI coding tools how to use Runpod directly from your editor or terminal. Once installed, you can ask your agent to create Pods, deploy Serverless endpoints, manage templates, and more — all through natural language.

Skills work with [Claude Code](https://docs.anthropic.com/en/docs/claude-code), [Cursor](https://www.cursor.com/), [GitHub Copilot](https://github.com/features/copilot), [Windsurf](https://codeium.com/windsurf), [Cline](https://github.com/cline/cline), and [17+ other AI agents](https://skills.sh/).
...
- [Runpod skills repository](https://github.com/runpod/skills) — source code and full skill definitions.
- [skills.sh](https://skills.sh/) — the skills platform with the full list of compatible AI agents.
- [Runpod CLI reference](/runpodctl/overview) — full runpodctl documentation.
- [MCP servers](/get-started/mcp-servers) — another way to integrate AI tools with Runpod.
