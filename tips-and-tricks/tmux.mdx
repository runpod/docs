...
You'll learn how to use TMUX to maintain persistent terminal sessions on your Runpod Pods, allowing you to run long-duration tasks without maintaining an active connection.

## Requirements

- Terminal access to your Runpod Pod (SSH, web terminal, or JupyterLab terminal)
...
TMUX is not installed by default on Runpod Pods. To install it:
