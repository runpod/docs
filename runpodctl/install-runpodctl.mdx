...
Runpod CLI is an [open-source](https://github.com/runpod/runpodctl) command-line interface (CLI) for managing Pods.
...
3. Give your key a name and set its permissions. If you want to [manage Pods](/pods/manage-pods) locally, your key will need **READ/WRITE** permissions (or **ALL**).
...
* [Manage your Pods](/pods/manage-pods) from the command line.
* [Transfer files](/pods/storage/transfer-files) between your local machine and Pods.
