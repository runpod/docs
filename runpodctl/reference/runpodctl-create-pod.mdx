...
```text
    --args string             Docker arguments for the container
    ...
    --env strings             environment variables to set in the container (see [Pod environment variables](/pods/references/environment-variables#pod-environment-variables))
