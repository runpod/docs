...
`serverless create`, `serverless get`, and `serverless list` include a `urls` object on each endpoint so you can invoke a freshly deployed endpoint without a second lookup:
...
```json
{
  ...
  "name": "my-vllm",
  "urls": {
    "run": "https://api.runpod.ai/v2/abc123/run",
    "runsync": "https://api.runpod.ai/v2/abc123/runsync",
    "health": "https://api.runpod.ai/v2/abc123/health"
  }
}
```
