...
# Swap the endpoint's template
runpodctl serverless update <endpoint-id> --template-id "tpl_newtemplate"
```
...
<ResponseField name="--template-id" type="string">
New template ID to swap the endpoint to. Use [`runpodctl template search`](/runpodctl/reference/runpodctl-template) to find templates.
</ResponseField>
