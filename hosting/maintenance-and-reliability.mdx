...
| Below 98% reliability | Machine is removed from the available GPU pool. |
...
- [Burn testing](/hosting/burn-testing) — Test your hardware before listing.
- [Partner requirements](/hosting/partner-requirements) — Secure Cloud partnership specifications.
