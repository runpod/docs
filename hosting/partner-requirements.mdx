...
| Speed Requirements      | - Preferred: >= 10 Gbps sustained upload/download speed per server<br/>- Minimum baseline: >= 5 Gbps sustained upload/download speed per server<br/>- Speed measurements should be based on sustained throughput over 60-second intervals during typical workloads                                                                                                |
