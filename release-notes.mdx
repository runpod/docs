...
**New** [REST API v2](/api-reference-v2/overview)
...
**Deprecation** REST API v1 and GraphQL API

REST API v1 will be retired on **December 1, 2026**. The GraphQL API will be retired in **early 2027**. For new integrations, use [REST API v2](/api-reference-v2/overview).
