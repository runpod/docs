...
<AccordionGroup>
      <Accordion title="June 2026" defaultOpen>
        ## Savings Plan IDOR vulnerability fixed
      ...
      <Accordion title="May 2026">
        ...
        ## New Pod deploy flow — workload-first GPU selection
        ...
        ## Active Worker discount reduced from 30% to 15%
