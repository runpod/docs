...
<AccordionGroup>
  <Accordion title="June 2026" defaultOpen>
    <h3><Badge color="green">New Release</Badge> High-Performance Network Volumes now available</h3>
    ...
    <Badge color="green">New Release</Badge>### Deploy When Available 
    ...
    <Badge color="blue">Improvement</Badge>### Hub navigation consolidated 
 
    Hub navigation items are now consolidated into a single unified entry, making it easier to find templates and repos.

    <Badge color="red">Bug Fix</Badge>### Billing records now show correct data for deleted resources 
  ...
  <Accordion title="May 2026">
    <Badge color="green">New Release</Badge>### Async Jobs for Serverless 
    ...
    <Badge color="green">New Release</Badge>### Serverless Worker Fitness Checks 
    ...
    <Badge color="green">New Release</Badge>### 24GB MiG instances now available 
    ...
    <Badge color="green">New Release</Badge>### Cost Centers now generally available 
    ...
    <Badge color="blue">Improvement</Badge>### New Pod deploy flow with workload-first GPU selection 
  ...
  <Accordion title="April 2026">
    <Badge color="green">New Release</Badge>### Flash is now generally available 
    ...
    <Badge color="green">New Release</Badge>### Instant Cluster Expansion and Priority FlashBoot now live 
    ...
    <Badge color="green">New Release</Badge>### FlashBoot for CPU Serverless now in public beta 
    ...
    <Badge color="blue">Improvement</Badge>### GPU price reductions across popular SKUs 
    ...
    <Badge color="red">Bug Fix</Badge>### Serverless GPU exclusions now correctly respected 
