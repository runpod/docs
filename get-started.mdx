...
<Tip>
If the GPU you want is out of capacity, use **Deploy When Available** to queue your Pod. Runpod deploys it automatically as soon as that GPU frees up. See [Deploy a Pod](/pods/deploy-a-pod) for both deployment paths.
</Tip>
