...
<Note>
  To switch back to the legacy flow, go to [Settings](https://console.runpod.io/user/settings) and toggle **Switch back to legacy deploy flow** under **Legacy Pod deploy flow**.
</Note>
