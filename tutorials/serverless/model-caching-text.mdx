...
<Tip>
You can download the finished code for this tutorial [on GitHub](https://github.com/runpod/cached-model-example). For a simpler starting point, see the [model-store-worker](https://github.com/stuffbyt/model-store-worker) example.
</Tip>
