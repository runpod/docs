...
In this tutorial, you will learn how to deploy a <ServerlessTooltip /> <EndpointTooltip /> running [Stable Diffusion XL](https://stablediffusionxl.com/) (SDXL) on Runpod, submit image generation jobs, monitor their progress, and decode the resulting images.
