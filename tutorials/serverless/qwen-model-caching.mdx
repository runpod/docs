---
title: "Deploy Qwen2.5 using cached models"
sidebarTitle: "Use cached models"
description: "Learn how to create a custom Serverless endpoint that uses cached models to serve Qwen2.5 with reduced cost and cold start times."
tag: "NEW"
---

This tutorial demonstrates how to build a custom Serverless worker that leverages Runpod's [cached models](/serverless/endpoints/model-caching) feature to serve the Qwen2.5 language model. You'll learn how to create a custom handler function that programmatically locates and loads cached models, which can significantly reduce costs and cold start times.
