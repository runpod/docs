...
Welcome to the world of <ServerlessTooltip /> AI development with the [Runpod Python SDK](https://github.com/runpod/runpod-python).
...
It is optimized for AI and machine learning workloads, simplifying the development of scalable, cloud-based AI applications. The SDK allows you to define <HandlerFunctionTooltip />s, conduct local testing, and utilize GPU support.
...
You can also see a library of complete Runpod samples in the [<WorkerTooltip /> library](https://github.com/runpod-workers) on GitHub. These samples are complete Python libraries for common use cases.
