...
<Steps>
  ...
  <Step title="Configure your Pod">
    ...
    - **Storage:** The default container and disk volume sizes set by the template should be sufficient for SDXL-Turbo. You can also add a [network volume](/storage/network-volumes) to your Pod if you want persistent storage.
