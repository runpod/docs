...
<Tip>
When you're just getting started with ComfyUI, it's important to use a workflow that was created for the specific model you intend to use. You usually can't just switch the Load Checkpoint node from one model to another and expect it to work optimally.
