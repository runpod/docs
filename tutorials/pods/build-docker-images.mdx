...
- Deploy a <PodTooltip /> for building Docker images.
...
4. (optional) Attach a <NetworkVolumeTooltip /> for larger image builds.
5. Select a <TemplateTooltip /> (for example, **Runpod Pytorch**).
