...
- **Persistent storage**: If you plan to work with SmolLM3 regularly, consider using a [network volume](/pods/storage/create-network-volumes) to persist your models and notebooks across Pod sessions.