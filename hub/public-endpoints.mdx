...
```
Here is an example using OpenAI API with streaming enabled.
<Tip>
Please use `stream_options={"include_usage": True}` for streaming to work with vLLM Public Endpoints.
</Tip>
