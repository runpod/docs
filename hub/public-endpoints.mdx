...
<CardGroup cols={2}>
  ...
  <Card title="Model reference" href="/hub/public-endpoint-reference" icon="book" iconType="solid">
    Browse available models and view their parameters.
  </Card>
  <Card title="Connect AI coding tools" href="/hub/ai-coding-tools" icon="screwdriver-wrench" iconType="solid">
    Configure Cursor, Cline, and OpenCode.
  </Card>
</CardGroup>
...
flowchart LR
    ...
    style api fill:#4D38F5,stroke:#4D38F5,color:#FFFFFF,stroke-width:2px
    style model fill:#4D38F5,stroke:#4D38F5,color:#FFFFFF,stroke-width:2px
...
- [Make API requests](/hub/public-endpoints-requests): Learn about the playground, async requests, SDKs, and best practices.
