...
You can find pricing information for each model in the [Runpod console](https://console.runpod.io/hub?tabSelected=public_endpoints).
...
https://console.runpod.io/hub/playground/audio/minimax-speech-02-hd
