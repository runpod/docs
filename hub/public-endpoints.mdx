...
Our initial launch includes optimized text-to-image generation models and LLM models:
...
| **Deep Cognito v2 70B** | The Deep Cogito v2 Llama 70B model is part of a groundbreaking family of open-source hybrid reasoning LLMs developed under a novel AI paradigm. | `https://api.runpod.ai/v2/deep-cogito-v2-llama-70b/` |
| **Qwen3 32B AWQ** | Qwen3 is the latest generation of large language models in Qwen series, offering a comprehensive suite of dense and mixture-of-experts (MoE) models. | `https://api.runpod.ai/v2/qwen3-32b-awq/` |
...
### vLLM Endpoints 
Our current vLLM models include: 
...
<Tip>
To learn more about sending requests to our vLLM Public Endpoints, see [vLLM Requests](/serverless/vllm/vllm-requests).
</Tip>
...
```
<Tip>
To learn more about sending requests to our vLLM Public Endpoints with the OpenAI-compatible API, see [OpenAI API compatibility](/serverless/vllm/openai-compatibility).
</Tip>

<Warning>
Streaming through the OpenAI API is currently not supported. 
</Warning>
