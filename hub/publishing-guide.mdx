...
This table contains a list of valid GPU pools that you can specify in the `gpuIds` field to determine which GPUs can be used by workers on a deployed instance of your repo.
