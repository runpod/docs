...
2. Under **Add your repo** click **Get Started**. If you haven't already linked your GitHub account to Runpod, you'll be prompted to do so.
  <Warning>
  To publish a repo to the Hub, you must have the appropriate access level for the repository on GitHub:
  - For personal repositories: Owner or collaborator.
  - For GitHub organizations: Write, maintain, or admin (or an equivelant custom role). See: [Repository roles](https://docs.github.com/en/enterprise-cloud@latest/organizations/managing-user-access-to-your-organizations-repositories/managing-repository-roles/repository-roles-for-an-organization) for more information.
  </Warning>
