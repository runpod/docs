...
If you already have repositories published in the Hub:

1. Navigate to your Runpod account settings.
2. Link your GitHub profile to enable verified maintainer status.
3. Your existing published repositories will automatically start earning revenue based on user deployments.

If you have not yet published to the Hub:

1. Follow the [publishing process](#how-to-publish-your-repo) to add your repositories.
2. Link your GitHub profile during or after the publishing process.
3. Once approved, your repositories will start generating revenue from user deployments.

Your revenue earnings and tier status can be monitored through your Runpod account dashboard.
