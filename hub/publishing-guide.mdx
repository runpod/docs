...
After you publish your repository to the Hub, you can start earning revenue from your users' compute usage. For details, see [Revenue sharing](/hub/revenue-sharing).
