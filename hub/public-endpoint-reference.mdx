...
| **FLUX.1 Kontext [dev]** | A 12 billion parameter rectified flow transformer capable of editing images based on text instructions. | `https://api.runpod.ai/v2/black-forest-labs-flux-1-kontext-dev/` | Image | \$0.03 per megapixel |
| **Deep Cogito v2 Llama 70B** | Open-source hybrid reasoning language model. | `https://api.runpod.ai/v2/deep-cogito-v2-llama-70b/` | Text | \$0.01 per 1000 tokens |
