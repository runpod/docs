...
The Qwen3 endpoint is fully compatible with vLLM and the OpenAI API, allowing you to use any of the parameters available in these frameworks. For more details, see [Send vLLM requests](/serverless/vllm/vllm-requests) and the [OpenAI API compatibility guide](/serverless/vllm/openai-compatibility). 

Below you'll find examples for how to use the Qwen3 32B AWQ model with the OpenAI API:
...
<Accordion title="vLLM Response format">
