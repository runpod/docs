---
title: "Connect AI coding tools with Runpod Public Endpoints"
...
<Steps>
  ...
  <Step title="Test the configuration">
    ...
    <Frame alt="OpenCode command palette">
      <img src="/images/ai-coding-opencode-command-palette.png" />
    </Frame>
...
<Steps>
  ...
  <Step title="Navigate to model settings">
    ...
    <Frame alt="Cursor model settings">
      <img src="/images/ai-coding-cursor-settings.png" />
    </Frame>
...
<Steps>
  ...
  <Step title="Enter the connection settings">
    ...
    <Frame alt="Cline settings">
      <img src="/images/ai-coding-cline-settings.png"   style={{ width: "400px", height: "auto" }} />
    </Frame>
  </Step>
