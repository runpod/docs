...
3. All resources previously owned by the Team, including Pods, endpoints, volumes, clusters, templates, secrets, and registry auth, transfer to the Organization automatically.
