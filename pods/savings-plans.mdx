...
When you opt for a savings plan during Pod deployment, you make an upfront commitment for a chosen duration, such as 3 months or 6 months. In return, you receive a significantly lower hourly rate for the Pod, which is typically for a specific GPU type on Secure Cloud or for CPU instances.
