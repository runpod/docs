...
A container disk houses the operating system and provides temporary storage for a <PodTooltip />. It's created when a Pod is launched and is directly tied to the Pod's lifecycle.
