...
<Warning>
Your encryption key cannot be retrieved after Pod creation. If you lose the key, you will not be able to recover data from the encrypted volume.
</Warning>

<Note>
Encryption applies to volume disk only. Container disk and network volumes cannot be encrypted.
</Note>
