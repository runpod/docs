...
<Note>
Cloud Sync is compatible with Google Cloud Storage, but **not Google Drive**. However, you can transfer files between your Pods and Drive [using the Runpod CLI](/runpodctl/transfer-files#transfer-files-between-google-drive-and-runpod).
</Note>
