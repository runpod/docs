...
If a migration stalls — for example, because the source host went offline — Runpod will automatically mark it as failed after a timeout. You'll be able to initiate a new migration once the failed migration is resolved.
