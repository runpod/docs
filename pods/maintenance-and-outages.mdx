...
Always keep at least one additional copy of critical data — whether in a network volume, an external object store, or a container registry. Use runpodctl or cloud syncs to automate backups. Runpod cannot guarantee recovery of data stored only on ephemeral container disk.
