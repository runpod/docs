...
To ensure uninterrupted workloads, maintain an account balance covering at least one hour of your current runtime. Runpod automatically stops Pods when your balance drops below the projected cost of your active workloads. Pods with attached network volumes are deleted (not just stopped) when this threshold is reached.

Enable [Auto-pay](/accounts-billing/billing#auto-pay) and set up [low-balance notifications](https://www.console.runpod.io/user/settings) with at least two hours of runway to avoid unexpected interruptions.

A default spend limit of \$80/hour applies across all resources. [Contact support](https://www.runpod.io/contact) to increase.
