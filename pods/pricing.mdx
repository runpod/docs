...
<Note>
If your account balance is insufficient to cover your remaining runtime, Runpod stops all Pods to preserve attached data volumes. We recommend enabling [Auto-pay](https://www.console.runpod.io/user/billing) to keep your balance up to date based on your hourly usage.
</Note>
