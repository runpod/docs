...
<Warning>
Savings plans only cover GPU compute costs—[storage costs](/pods/storage/types) are billed at standard rates. Storage charges continue to accrue on stopped Pods. If your balance reaches \$0, your Pods will stop and storage may be deleted. Plans are non-refundable and have fixed expiration dates.
</Warning>
...
- **Minimum balance**: Pods are automatically stopped when your account balance reaches \$0. To avoid interruptions, enable [low balance notifications](/accounts-billing/billing#low-balance-notifications) or set up [auto-pay](https://www.console.runpod.io/user/billing).
