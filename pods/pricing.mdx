...
4.  Review your Pod's configuration details, including the terms of the selected pricing model.
...
Storage is billed per minute. You are not charged for storage if the host machine is down or unavailable from the public internet.
