...
- **Minimum balance**: If your balance can no longer cover 25 minutes of your current workloads, Runpod stops all Pods to preserve data volumes. Set up [automatic payments](https://www.console.runpod.io/user/billing) to avoid interruptions.
