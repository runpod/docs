...
- **Minimum balance**: If your balance is insufficient to cover your remaining runtime, Runpod stops all Pods to preserve data volumes. Set up [automatic payments](https://www.console.runpod.io/user/billing) to avoid interruptions.
