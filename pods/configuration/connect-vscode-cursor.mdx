...
This guide explains how to connect directly to your Pod instance through VSCode or Cursor using the Remote-SSH extension, allowing you to work within your Pod's volume directory as if the files were stored on your local machine.

## Requirements

Before you begin, you'll need:

- A running Pod instance. See [Manage Pods](/pods/manage-pods#create-a-pod) for deployment instructions.
...
To connect to your Pod, you'll need to install the Remote-SSH extension:

<Tabs>

  <Tab title="VSCode">
    1. Open VSCode and navigate to the **Extensions** view (Ctrl+Shift+X or Cmd+Shift+X).
    2. Search for and install **Remote - SSH** by ms-vscode-remote (Microsoft).
  </Tab>

  <Tab title="Cursor">
    1. Open Cursor and navigate to the **Extensions** view (Ctrl+Shift+X or Cmd+Shift+X).
    2. Search for and install **Remote - SSH** by Anysphere (Cursor).
  </Tab>
...
You should now be connected to your Pod instance, and can work on your volume directory as if it were local.
