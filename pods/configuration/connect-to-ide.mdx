---
title: "Connect a Pod to VSCode or Cursor"
sidebarTitle: "Connect to IDE"
description: "Set up remote Pod development with Visual Studio Code or Cursor IDE."
---
...
To connect to your Pod, you'll need to install the Remote-SSH extension for your IDE:
...
## Step 3: Configure SSH for your IDE
...
<Tabs>
  ...
  <Tab title="VSCode">
   ...
   <Note>
   If you only see one command, it is because SSH over exposed TCP is not supported by your selected GPU or template.
   </Note>
