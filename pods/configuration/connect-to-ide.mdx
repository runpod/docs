...
If your Pod is already running when you upload the key, the system will not perform this injection. To enable SSH access, you'll need to either restart your Pod, or manually add your public key to the `~/.ssh/authorized_keys` file inside your Pod.
</Warning>
