...
To quickly set up password-based SSH, copy and paste this code into your Pod's terminal:
...
After pasting the script into your terminal and entering a password, you'll see example commands for SSH or SCP:
