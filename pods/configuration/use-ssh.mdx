...
Before connecting, [add your SSH public key to the Credentials page](/get-started/credentials#ssh-public-keys). In individual and team accounts, all SSH keys in your account are injected into all your Pods. If you add a new key while a Pod is already running, it is injected dynamically without a restart.
...
<Steps>
  <Step title="Generate an SSH key pair">
    Ensure you have an [SSH public key added to your account](/get-started/credentials#ssh-public-keys).
  </Step>
