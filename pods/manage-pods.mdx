...
## Report a problem with a template

When you open a Pod's details, the **Template details** section shows information about the template the Pod is running. If the template isn't working as expected, click **Report problem with template** to open a feedback form and describe the issue. Your feedback goes to the Runpod team to help improve the template.
