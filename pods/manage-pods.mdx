...
When you stop a Pod, the GPU attached to your machine instance is released and may be allocated to another user. If you later try to start the Pod again, you may  be assigned zero GPUs.
