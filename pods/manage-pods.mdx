...
When you stop a Pod, the GPU attached to your machine instance is released and may be allocated to another user. If you later try to start the Pod again, there may be no GPUs available, and you could be forced to launch the machine with 0 GPUs.

[Why do I have zero GPUs assigned to my Pod?](../references/faq.mdx##why-do-i-have-zero-gpus-assigned-to-my-pod)
