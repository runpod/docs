...
When you start a Pod, this locks your Pod to that specific physical machine in a datacenter. As long as you keep your Pod running you'll maintain access to it, and your instance charges will stay the same.
