...
[By stopping a Pod you are releasing the GPU on the machine, and you could be reallocated 0 GPUs when start the Pod again](/references/faq#why-do-i-have-zero-gpus-assigned-to-my-pod%3F)
