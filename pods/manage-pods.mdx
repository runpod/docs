...
When using <TemplatesTooltip /> (especially community templates like `runpod/pytorch:2.8.0-py3.11-cuda12.8.1-cudnn-devel-ubuntu22.04`), ensure the CUDA version of the host <MachineTooltip /> matches or exceeds the template's requirements.
