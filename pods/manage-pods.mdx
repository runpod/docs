...
By stopping a Pod you are effectively releasing the GPU on the machine, and your original GPU may become unavailable when you restart the Pod. Runpod provides automatic migration options to help you get back to work quickly. For more info, see the [FAQ](/references/faq#why-am-i-being-asked-to-migrate-my-pod).
