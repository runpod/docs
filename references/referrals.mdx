...
- **Bonus credits** for both you and your referral after they load \$10 on their account. The bonus amount depends on your location:
  - **Non-EU customers** receive a random weighted bonus between \$5 and \$500.
  - **EU customers** receive a fixed \$5 bonus.
  - **Cross-region referrals**: If an EU customer refers a non-EU customer, the EU customer receives \$5 and the non-EU customer receives the random weighted bonus (\$5-\$500). If a non-EU customer refers an EU customer, the non-EU customer receives the random weighted bonus and the EU customer receives \$5.
...
3. **Bonus credit distribution varies by location.** Non-EU customers receive credits through a weighted random system between \$5 and \$500, while EU customers receive a fixed \$5 bonus. For non-EU customers, most will receive a bonus of \$5, with about 96% receiving \$10 or less.
