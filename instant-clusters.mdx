...
<CardGroup cols={3}>
  ...
  <Card title="Deploy a PyTorch distributed training cluster" href="/instant-clusters/pytorch" icon="fire" horizontal>
    Set up multi-node PyTorch training for deep learning models.
  </Card>
  <Card title="Deploy an Axolotl fine-tuning cluster" href="/instant-clusters/axolotl" icon="screwdriver" horizontal>
