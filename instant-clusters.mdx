...
* High-speed networking from 100 Gbps to 3200 Gbps within a single data center.
* Clusters range from 2 GPUs to hundreds across multiple machines.
* Supports H100s, A100s, RTX series GPUs and more.
* Automatic cluster configuration with static IP and [environment variables](#environment-variables).
* Enterprise-grade infrastructure with automated monitoring and failovers.
...
* Most clusters include 100 Gbps networking.
* H100 models offer up to 3200 Gbps networking.
