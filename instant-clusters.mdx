...
Runpod offers custom Instant Cluster pricing plans for large scale and enterprise workloads. If you're interested in learning more, [contact our sales team](https://meetings.hubspot.com/runpodsales/runpod).
...
* [Deploy an Instant Cluster with Slurm (managed)](/instant-clusters/slurm-managed).
