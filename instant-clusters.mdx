...
<CardGroup>
  ...
  <Card title="Distributed training with Slurm" href="/instant-clusters/slurm-training" icon="layer-group" iconType="solid">
    Submit distributed PyTorch training jobs through Slurm. Learn to write sbatch scripts that automatically coordinate execution across all nodes in your cluster.
  </Card>
...
- [Configuration reference](/instant-clusters/configuration): Learn about environment variables, network interfaces, and NCCL configuration.
