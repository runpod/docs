---
title: "Cost centers"
description: "Track and organize Runpod spending by team, project, or department using cost centers."
---

Cost centers let you attach billing labels to your Runpod resources to track and manage spending across your organization. By grouping Pods, Serverless endpoints, network volumes, and Instant Clusters into cost centers, you can attribute charges to specific teams, projects, or departments.
...
### Move resources between cost centers

To reassign a resource from one cost center to another:

1. Navigate to the [Cost center page](https://www.console.runpod.io/user/cost-center/tags).
2. Expand the cost center containing the resource you want to move.
3. Select the checkbox next to the resource.
4. Select **Add resources to cost center** and choose the new cost center.

The resource will be removed from its current cost center and added to the new one. Historical billing data remains associated with the original cost center for the period when the resource was assigned there.
...
Your Runpod invoices include a breakdown of total spend by cost center. This allows you to see how charges are distributed across your organization's cost centers for each billing period.
...
Each invoice shows the total amount spent per cost center during that billing period, making it easy to allocate charges to the appropriate teams or budgets in your financial systems.
