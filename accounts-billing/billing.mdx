...
Runpod monitors your account balance in real time. Billing ticks every 5 minutes, and charges are deducted continuously based on the resources you have running.

When your balance reaches \$0, Runpod automatically stops all of your running Pods.

- Stopped Pods retain their volume storage, but storage charges continue to accrue.
- If your balance stays at \$0 and storage charges can't be covered, your Pods and their associated storage may be deleted. Deleted data can't be recovered.
