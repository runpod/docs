...
<Important>
Enable [Auto-pay](#auto-pay) and set up [low-balance notifications](https://www.console.runpod.io/user/settings) with at least two hours of runway to avoid unexpected interruptions.
</Important>
