...
For step-by-step instructions on inviting a member and choosing their role, see [Assign a role to a team member](/accounts-billing/organizations/roles-and-permissions#assign-a-role-to-a-team-member).
...
Your account will gain access to the team's resources based on the role assigned to you. To see what your assigned role allows, see [Roles and permissions](/accounts-billing/organizations/roles-and-permissions).
...
For the full permissions matrix and guidance on assigning and revoking roles, see [Roles and permissions](/accounts-billing/organizations/roles-and-permissions).
