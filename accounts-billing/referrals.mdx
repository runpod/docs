...
- They must be a first-time Runpod user. If they previously had a Runpod account under the same email address, including a deleted account, they are not eligible for referral rewards.
- They must have signed up after June 15, 2025. Accounts created before this date are not eligible.
- They must load at least \$10 onto their account. Runpod awards the bonus credits only after they meet this minimum \$10 load.
