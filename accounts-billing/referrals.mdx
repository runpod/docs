...
For a referral to qualify for rewards, the person you refer must meet the following requirements:

- They must sign up using Google SSO. Referrals who sign up through any other method are not eligible for rewards.
- They must be a first-time Runpod user. If they previously had a Runpod account under the same email address, they are not eligible.
