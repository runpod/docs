...
{/*
Hidden per PR #804 review: tax is not yet enabled for India, so this section is not yet accurate. To restore, delete this note line and the surrounding comment markers.
